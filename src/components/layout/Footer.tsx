        ...
        <div className="">
            ...
            <div>
                <div className="flex gap-2 justify-center 
                 sm:justify-start text-teal-600">
                 <Logo />
                 <h1 className=" text-[26px] font-bold">ToureMate</h1>
                </div>

                <p className="mt-6 max-w-md text-center leading-relaxed text-foreground/45 
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                ...
                <p className="text-lg font-medium text-foreground/90">About Us</p>

                <ul className="mt-8 space-y-4 text-sm">
                    <li>
                    <a className="text-foreground/45 transition hover:text-foreground/75" href="#">
                        Company History
                    </a>
                    </li>
                ...
                <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-foreground/90">Our Services</p>
                ...
                <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-foreground/90">Helpful Links</p>
