...
const GuideCard = ({ tour }: { tour: Tour }) => {
  return (
    <div
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="grow">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs sm:text-sm text-foreground">{tour.rating}</span>
          </div>
          <p className="text-xs sm:text-sm text-muted-foreground line-clamp-2">
            Experienced guide passionate about sharing local knowledge and
