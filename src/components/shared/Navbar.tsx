...
// import { Menu, X, LogOut, Settings, BarChart3, HelpCircle } from "lucide-react";
...
//           }`}
//         >
//           <nav className="pb-4 border-t border-border">
//             <div className="flex flex-col gap-3 pt-4 animate-in fade-in-0 slide-in-from-top-2 duration-300">
//               {navItems.map((item) => (
//                 <Link
